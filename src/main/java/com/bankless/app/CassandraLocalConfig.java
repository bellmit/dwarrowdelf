...
public class CassandraLocalConfig {
    ...
    //2020-09-29 16:44:36.749 ERROR 5649 --- [pool-2-thread-1] o.a.cassandra.service.StartupChecks      : cassandra.jmx.local.port missing from cassandra-env.sh, unable to start local JMX service.
