...
public class CassandraTestConfigProperties {
	...
	private CassandraTestConfigProperties.Service service;

	private CassandraTestConfigProperties.Replication replication;

	public CassandraTestConfigProperties() {
	}
